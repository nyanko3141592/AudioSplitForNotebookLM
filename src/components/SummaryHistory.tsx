...
export const const SummaryHistory: React.FC = () => {
  ...
  const handleDownloadAllTranscriptions = (transcriptionResults: TranscriptionResult[], title: string, timestamp: number) => {
          ...
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            ...
            <div className="space-y-4">
              ...
              {history.length > 0 && (
                <div className="pt-4 border-t">
                  <div className="mb-3">
                    <h4 className="text-sm font-medium text-gray-700 mb-1">データ管理</h4>
                    <p className="text-xs text-gray-500">
                      すべての要約履歴を削除します。この操作は取り消せません。
                    </p>
                  </div>
                  <button
                    onClick={() => {
